...
export const GROUPS: Group[] = [
  ...
  { id: '00000000-0000-4000-8000-00000000beef', name: 'Escuadrón Prueba', leagueName: 'Liga de Prueba', tag: 'EUW', initials: 'EP', role: 'Miembro', members: 30, c1: 'hsl(260,85%,62%)', c2: 'hsl(280,75%,32%)' },
